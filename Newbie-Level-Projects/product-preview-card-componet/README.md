...
<ul>
    <li>The purpose of the project is to create a Product Preview Card Component using HTML and CSS in React JS.</li>
...
```bash
git clone https://github.com/BerkayAytekin/Projects/tree/main/Newbie-Level-Projects/product-preview-card-componet
cd project_name
```
...
```bash
product-preview-card-component-fm.surge.sh
```

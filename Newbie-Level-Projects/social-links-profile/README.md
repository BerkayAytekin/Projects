...
<ul>
    <li>The purpose of the project is to create a Social Links Profile using HTML and CSS in React JS.</li>
...
```bash
git clone https://github.com/BerkayAytekin/Projects/tree/main/Newbie-Level-Projects/social-links-profile
cd project_name
```
...
```bash
social-links-profile-fm.surge.sh
```

...
<ul>
    <li>The purpose of the project is to create a QR Code Component using HTML and CSS in React JS.</li>
...
```bash
git clone https://github.com/BerkayAytekin/Projects/tree/main/Newbie-Level-Projects/qr-code-component
cd project_name
```

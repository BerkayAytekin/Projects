...
<ul>
    <li>The purpose of the project is to create a Stats Preview Card Component using HTML and CSS in React JS.</li>
...
```bash
git clone https://github.com/BerkayAytekin/Projects/tree/main/Newbie-Level-Projects/stats-preview-card-component
cd project_name
```
...
```bash
stats-preview-card-component-fm.surge.sh
```

<h1>Result Summary Component</h1>
<ul>
    <li>The purpose of the project is to create a Result Summary Component using HTML and CSS in React JS.</li>
...
```bash
git clone https://github.com/BerkayAytekin/Projects/tree/main/Newbie-Level-Projects/result-summary-component
cd project_name
```
...
```bash
result-summary-component-fm.surge.sh
```

<h1>Three Column Preview Card Component</h1>
<ul>
    <li>The purpose of the project is to create a Three Column Preview Card Component using HTML and CSS in React JS.</li>
...
```bash
git clone https://github.com/BerkayAytekin/Projects/tree/main/Newbie-Level-Projects/three-column-preview-card-component
cd project_name
```
...
```bash
three-column-preview-card-component-fm.surge.sh
```
